...
# Wrinkles Classification Model

## Overview
This model card provides documentation for the Wrinkles Detection model checkpoint used in the Hugging Face pipeline. The model is designed to assess wrinkle / non-wrinkle.
